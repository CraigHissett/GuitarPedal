/**
 * ControllerMan - Craig's version.
 * 
 * To Do:
 * https://create.arduino.cc/projecthub/jonasvugt/turn-an-arduino-uno-into-a-midi-controller-guitar-pedals-ac36a2?ref=search&ref_id=MIDI&offset=42
 * Add analog jack for expressionpedal
 * Increase buttons?
 * Review screen code
 * 
 * 
